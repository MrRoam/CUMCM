...
def main():
    ...
    root=HERE/'runs/random_audit';case=json.loads((root/'cases.json').read_text(encoding='utf-8'))[0]
    selection=json.loads((root/case['name']/'selection.json').read_text(encoding='utf-8'))
    variants={};receipts={}
