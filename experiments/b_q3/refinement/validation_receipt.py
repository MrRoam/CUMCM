...
for name in ('confirm','stress','random_audit','micro_confirm'):
    ...
    analysis=json.loads((p/'analysis.json').read_text(encoding='utf-8'))
    ...
    proof=json.loads((p/'filter_verification.json').read_text(encoding='utf-8'))
...
micro=json.loads((HERE/'runs/micro_confirm/manifest_current_f1_f2_f3_f4_baseline.json').read_text(encoding='utf-8'))
root=HERE.parents[2]
