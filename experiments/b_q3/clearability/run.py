...
def main():
    ...
    args=p.parse_args();args.out=a.base.new_run(args.out)
    cases=[c.to_dict() for c in a.base.read_cases(args.cases)];a.base.dump(args.out/'cases.json',cases)
    ...
    a.base.finish_run(args.out, len(cases)*len(args.modes))
